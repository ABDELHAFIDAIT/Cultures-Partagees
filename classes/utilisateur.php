<?php
    ...
    class Utilisateur extends User{
        ...
        // SIGNUP METHOD
        public function register(string $nom, string $prenom,string $phone,string $email,string $password,string $role = 'Utilisateur',string $photo){
            ...
            try {
                ...
                $stmt = $test->prepare("INSERT INTO users (prenom, nom, telephone, email, password, role, photo) VALUES (:prenom, :nom, :phone, :email, :pw , :role, :photo)");
