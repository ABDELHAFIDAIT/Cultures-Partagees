...
<body>
    ...
    <!-- Footer -->
    <footer class="w-full py-8 bg-[#b316bd]">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                ...
                <ul
                    class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-8 mb-10 border-b border-gray-200">
                    <li><a href="#" class="text-white hover:text-black">Pagedone</a></li>
                    <li><a href="#" class=" text-white hover:text-black">Products</a></li>
                    <li><a href="#" class=" text-white hover:text-black">Resources</a></li>
                    <li><a href="#" class=" text-white hover:text-black">Blogs</a></li>
                    <li><a href="#" class=" text-white hover:text-black">Support</a></li>
                </ul>
                ...
                <span class="font-extralight text-lg text-white text-center block">
                    ©<a href="#">CultureConnect</a> 2025 , All rights reserved.
                </span>
            </div>
        </div>
    </footer>
